...
Este repositório foi modularizado para facilitar a navegação. Cada diretório abaixo contém um material de estudo detalhado, exemplos práticos e resumos teóricos formatados de acordo com os padrões da ABNT.
...
### [7. Regras de Inferência](./modulo07/README.md)
...
As referências abaixo baseiam-se na ementa e materiais de apoio acadêmicos, padronizadas de acordo com as normas **ABNT NBR 6023:2018** e **ABNT NBR 10520:2023**:

*   HAACK, Susan. **Filosofia das lógicas**. Tradução de Cezar A. Mortari e Luiz Henrique de A. Dutra. 2. ed. São Paulo: Editora Unesp, 2002. 359 p.
...
*   MARTINS, Luiz Gustavo. **Apostila de Lógica Proposicional**: dedução natural, sintaxe e semântica. Santo André: Universidade Federal do ABC, 2012. 45 p.
